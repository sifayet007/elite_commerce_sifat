  ...
  return (
    <div className="mt-24">
      <div className="text-center">
        <h1>
          Solution-wise Features of <span>Elite Commerce</span>
        </h1>
        <p>
          Meet the dynamic features of <span>Elite Commerce</span> that comes
          with Customer Panel, admin panel, and other solutions.
        </p>
        <div className="flex gap-x-5 justify-center">
          <div className="relative inline-block group mt-[30px]">
            ...
            <Button
              ...
              className={`relative z-10 px-6 py-2  text-lg font-semibold  hover:bg-gradient-to-tr hover:text-white text-green-500  hover:shadow-sm hover:shadow-green-500 from-[#0CE47F] to-[#01904D] rounded-[6px] cursor-pointer  shadow-lg ${
          ...
          <div className="relative inline-block group mt-[30px]">
            ...
            <Button
              ...
              label="Customer Panel"
              className={`relative z-10 px-6 py-2  text-lg font-semibold  hover:bg-gradient-to-tr hover:text-white text-green-500  hover:shadow-sm hover:shadow-green-500 from-[#01904D] to-[#0CE47F] rounded-[6px] cursor-pointer  shadow-lg ${
